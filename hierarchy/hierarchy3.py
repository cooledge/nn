...
class HierarchyModel:
  ...
  def __init__(self, hierarchy, hierarchy_outputs):
  ...
  def init_hmodel(self):
    ...
    self.model_hierarchy_output = tf.split(tf.clip_by_value(self.model_input + l1 + l2 + l3 + l4, 0.0, 1.0), [self.number_of_outputs], axis=1)[0]
...
if __name__ == "__main__":
  ...
  hierarchy_model = HierarchyModel(hierarchy, houtputs)
