...
def AutoEncoder():
  ...
  return decoder_A, model_input, model_output

autoencoder_A, model_input, model_output = AutoEncoder()
...
epochs = 10000
steps = 50
batches = len(images_A) // BATCH_SIZE
...
for epoch in range(epochs):
  ...
  for step in range(steps):
    ...
    print("Step: {0} loss_a: {1}/{2}\r".format(step, loss_A))
    show_graph(sess)
