...
baseline_history = baseline_model.fit(train_data, train_labels, epochs=EPOCHS, batch_size=512, validation_data=(test_data, test_labels), verbose=2)
...
#smaller_history = smaller_model.fit(train_data, train_labels, epochs=EPOCHS, batch_size=512, validation_data=(test_data, test_labels), verbose=2)
...
#bigger_history = bigger_model.fit(train_data, train_labels, epochs=EPOCHS, batch_size=512, validation_data=(test_data, test_labels), verbose=2)
...
l2_model.summary()
#l2_history = l2_model.fit(train_data, train_labels, epochs=EPOCHS, batch_size=512, validation_data=(test_data, test_labels), verbose=2)
...
dpt_model.summary()
dpt_history = dpt_model.fit(train_data, train_labels, epochs=EPOCHS, batch_size=512, validation_data=(test_data, test_labels), verbose=2)
plot_history([('baseline', baseline_history), ('dpt', dpt_history)])
plt.show()
